...
object GooglePlayIntegration {
    ...
    private fun publisher(googlePlayJson: String?, applicationName: String): AndroidPublisher {
        val googlePlayJson_ = googlePlayJson
                ?: KintaEnv.get(KintaEnv.Env.GOOGLE_PLAY_JSON)
                ?: KintaEnv.getOrFail(KintaEnv.Env.GOOGLE_PLAY_JSON)
    ...
    fun uploadDraft(googlePlayJson: String? = null,
        ...
        val packageName_ = packageName ?: KintaEnv.getOrFail(KintaEnv.Env.GOOGLE_PLAY_PACKAGE_NAME)
    ...
    fun isConfigured() =
            KintaEnv.get(KintaEnv.Env.GOOGLE_PLAY_JSON)?.isNotBlank() == true
                    && KintaEnv.get(KintaEnv.Env.GOOGLE_PLAY_PACKAGE_NAME)?.isNotBlank() == true
}
